...
<head>
    ...
    <title>Bắt đầu con đường ghẹo nào đồng nghiện</title>
    ...
    <div class="row">
        <div class="col-md-4 offset-md-4">
            <form action="login_process.php" method="post">
                <div class="mb-3">
                    <label for="username" class="form-label">Nhập tài khoản đi người anh em:</label>
                    <input type="text" class="form-control" id="username" name="username" required>
                </div>
                <div class="mb-3">
                    <label for="password" class="form-label">Cả mật khẩu nữa:</label>
